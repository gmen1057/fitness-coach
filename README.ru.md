...
- **Multi-Provider AI**: Выбирайте Anthropic Claude, OpenAI GPT или self-hosted Ollama
...
- **Разговорный коучинг**: Естественный чат с возможностями вызова инструментов
