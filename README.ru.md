...
- **Контроль здоровья и травм**: Учет физических ограничений тренером и автоматическое исключение травмоопасных упражнений
- **Логирование биомаркеров**: Сохранение результатов анализов крови (гормоны, липиды) для выявления перетренированности и оптимизации восстановления
